    ...
    <main class="py-20 px-4 sm:px-8 lg:px-16">
      ...
      <section class="text-center mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white text-black p-6 rounded-lg shadow-lg">
            <div class="mb-4 flex justify-center">
              <img src="https://img.freepik.com/free-photo/technology-human-touch-background-modern-remake-creation-adam_53876-129794.jpg?w=1380&t=st=1716226619~exp=1716227219~hmac=6fcd866ef5648028cf8008055ccc302473fe5bbaa0c9edd5472b409d7dc1d723" alt="Stap 2" class="w-48 h-48 object-cover">
            </div>
          ...
          <div class="bg-white text-black p-6 rounded-lg shadow-lg">
            <div class="mb-4 flex justify-center">
              <img src="https://img.freepik.com/free-photo/glowing-filament-ignites-ideas-innovative-solutions-generated-by-ai_188544-9614.jpg?w=1380&t=st=1716226589~exp=1716227189~hmac=2dcec61cdc3bff70157fb8587ce8a9f5b26f6c6fd499a529fc309ab83a5091ba" alt="Stap 3" class="w-48 h-48 object-cover">
            </div>
